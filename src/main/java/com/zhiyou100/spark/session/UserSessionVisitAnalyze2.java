 ...
 */
public class UserSessionVisitAnalyze2 {
...
//		System.out.println(ParamUtils.getParam(jsonObject, "cities"));
		...
		// 筛选数据（按条件）
		JavaPairRDD<String, String> filter_data = getfilter_data(allAggrInfo, jsonObject);
		
		List<Tuple2<String, String>> list = filter_data.collect();
	...
	public static JavaPairRDD<String, String> getfilter_data(JavaPairRDD<String, String> data, JSONObject jsonObject) {
		...
		JavaPairRDD<String, String> filter_age = data.filter(new Function<Tuple2<String, String>, Boolean>() {
			...
			public Boolean call(Tuple2<String, String> tuple) throws Exception {
				...
				//按照城市进行过滤
/*				if (!ValidUtils.equal(aggrInfo, Constants.FIELD_CITY, _param, Constants.PARAM_CITIES)) {
					return false;
				}*/
/*				if (!ValidUtils.equal(aggrInfo, Constants.FIELD_PROFESSIONAL, _param, Constants.PARAM_PROFESSIONALS)) {
					return false;
				}*/
